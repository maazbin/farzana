# Farzana documentation

| Doc | Purpose |
|-----|---------|
| [SETUP.md](./SETUP.md) | Local + webhook setup |
| [INSPIRATION.md](./INSPIRATION.md) | **Deep story:** Inspector Jamshed, Farzana, Mehmood, Farooq, myth → product |
| [STORY.md](./STORY.md) | Product story, name, phases |
