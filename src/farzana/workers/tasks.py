"""Tasks — single-user messages, voice, close, proactive."""
...
def handle_text_message(
    ...
    if raw.lower().startswith("/start"):
        reply = (
            ...
            "I am your personal memory aide (single-user).\n"
            "• Text or voice notes\n"
            "• Note this: name — open a session\n"
            "• /close — extract promises\n"
            "• /brief — discuss open loops\n"
            "• /quiet — pause proactive\n"
            "• /help\n\n"
            "I remember. I don't act outside your vault."
        )
...
def handle_voice_message(
    ...
    try:
        ...
        if not file_path:
            ...
            return {"ok": False}
        dest = Path(tempfile.gettempdir()) / "farzana" / f"voice-{file_id[:12]}.ogg"
